...
file_name <- "GLM_2_BinomialProportions_exercise_solutions"
paste0("- [", link_name, "](", file_name, ".html)") %>%
cat(sep="\n\n")
```
...
link_name <- "GLM - Bernoulli (0/1 data) exercise: Rays maturity"
file_name <- "GLM_2_Bernoulli_RayBin_exercise_solutions"
paste0("- [", link_name, "](", file_name, ".html)") %>%
cat(sep="\n\n")
```

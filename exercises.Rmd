...
### Day 2
 ...
 - [GLM - binomial (proportion data) exercise](GLM_2_BinomialProportions_exercise.html)
 
\  

### Day 3

 - [GLM - binomial (0/1 data) exercise: Rays maturity](GLM_3_Binomial_RayBin_exercise.html)

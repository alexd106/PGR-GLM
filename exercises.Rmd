...
### Day 1
 ...
 - [GLM - Poisson exercise](GLM_1_Poisson_exercise.html)

\  
 
### Day 2

 - [GLM - binomial (0/1 data) exercise: Rays maturity](GLM_2_Binomial_RayBin_exercise.html)
 - [GLM - binomial (0/1 data) optional exercise #1: Dolphins activity](GLM_2_Optional_Binomial_Dolphins_exercise.html)
 - [GLM - binomial (0/1 data) optional exercise #2: Dolphins extension](GLM_2_Optional_Binomial_Dolphins_extension_exercise.html)

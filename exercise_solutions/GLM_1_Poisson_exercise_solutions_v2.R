...
>>>>>>> f3d3bf0f3f1a7d9fa76ad7d959fade605b086ba4
summary(sp.glm2)
...
## ----Q12, eval=TRUE, echo=SOLUTIONS, results=SOLUTIONS, collapse=TRUE, fig.height=8-----------------------------
par(mfrow= c(1, 1))
...
## ----Q14, eval=TRUE, echo=SOLUTIONS, results=SOLUTIONS, collapse=TRUE, fig.height=8-----------------------------
...
## ----Q15, eval=TRUE, echo=SOLUTIONS, results=SOLUTIONS, collapse=TRUE, fig.height=8-----------------------------

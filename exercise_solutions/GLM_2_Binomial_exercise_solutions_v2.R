...
<<<<<<< HEAD
## ----Q6, eval=TRUE, echo=TRUE, results=SOLUTIONS, collapse=TRUE-------------------------------------------------
library(car)
vif(PA1)
# No concern.
...
## ----Q6c, eval=TRUE, echo=TRUE, results=SOLUTIONS, collapse=TRUE------------------------------------------------
par(mfrow= c(2, 2))
# plot the residuals against tideangle_deg
plot(res.PA1.p ~ dat$tideangle_deg, col= dat$presence + 1)
# get the mean of the residuals for each 1 degree bin of tideangle_deg
...
## ----QA1c, eval=TRUE, echo=SOLUTIONS, results=SOLUTIONS, collapse=TRUE------------------------------------------
# residual analysis:

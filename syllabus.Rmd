...
The live sessions will be held on Blackboard via Microsoft Teams at the time indicated in the timetable below. The recorded video lectures will be hosted on MyAberdeen and you should watch them at the time indicated below.
...
```{r timetable, echo=FALSE, warning = FALSE, message=FALSE}
library(kableExtra)

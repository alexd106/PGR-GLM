...
```{r Q6, eval=TRUE, echo=TRUE, results=SOLUTIONS, collapse=TRUE}
library(car)
vif(PA1)
# No concern.
...
```{r Q6c, eval=TRUE, echo=TRUE, results=SOLUTIONS, collapse=TRUE}
par(mfrow= c(2, 2))
...
```{r QA1c, eval=TRUE, echo=SOLUTIONS, results=SOLUTIONS, collapse=TRUE}
# residual analysis:
